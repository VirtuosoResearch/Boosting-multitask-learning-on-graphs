...
class R_GAMLP(PrecomputingBase):  # recursive GAMLP
    def __init__(self, in_channels, hidden_channels, out_channels, num_layers, dropout, use_bn=True,
        input_drop=0.0, att_dropout=0.0, alpha=0.5, n_layers_1=2, n_layers_2=2, act="relu", pre_process=False, residual=False, pre_dropout=False, bns=False):
        super(R_GAMLP, self).__init__(in_channels, hidden_channels, out_channels, num_layers, dropout, use_bn)
    ...
    def forward(self, feature_list, return_softmax=True):
        ...
        if return_softmax:
            right_1 = F.log_softmax(right_1, dim=1)
...
class JK_GAMLP(PrecomputingBase):
    def __init__(self, in_channels, hidden_channels, out_channels, num_layers, dropout, use_bn=True,
        input_drop=0.0, att_dropout=0.0, alpha=0.5, n_layers_1=2, n_layers_2=2, act="relu", pre_process=False, residual=False,pre_dropout=False,bns=False):
        super(JK_GAMLP, self).__init__(in_channels, hidden_channels, out_channels, num_layers, dropout, use_bn)
